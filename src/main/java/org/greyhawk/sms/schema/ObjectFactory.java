 ...
 * generated in the org.greyhawk.sms.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _SendSmsRingtoneResponse_QNAME = new QName("http://www.chinatelecom.com.cn/schema/ctcc/sms/send/v2_1/local", "sendSmsRingtoneResponse");
    private final static QName _GetSmsDeliveryStatus_QNAME = new QName("http://www.chinatelecom.com.cn/schema/ctcc/sms/send/v2_1/local", "getSmsDeliveryStatus");
    private final static QName _GetSmsDeliveryStatusResponse_QNAME = new QName("http://www.chinatelecom.com.cn/schema/ctcc/sms/send/v2_1/local", "getSmsDeliveryStatusResponse");
    private final static QName _SendSmsLogoResponse_QNAME = new QName("http://www.chinatelecom.com.cn/schema/ctcc/sms/send/v2_1/local", "sendSmsLogoResponse");
    private final static QName _SendSmsLogo_QNAME = new QName("http://www.chinatelecom.com.cn/schema/ctcc/sms/send/v2_1/local", "sendSmsLogo");
    private final static QName _SendSmsRingtone_QNAME = new QName("http://www.chinatelecom.com.cn/schema/ctcc/sms/send/v2_1/local", "sendSmsRingtone");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.greyhawk.sms.schema
     * 
     */
